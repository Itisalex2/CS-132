...
public class IRVisitor extends GJDepthFirst<IRStruct, functionStruct> {
  ...
  /**
   * Grammar production: f0 -> ( Instruction() )* f1 -> "return" f2 ->
   * Identifier()
   * NodeListOptional f0
   * NodeToken f1
   * Identifier f2
  ...
  /**
   * Grammar production: f0 -> Identifier() f1 -> "=" f2 -> "@" f3 ->
   * FunctionName()
   * Identifier f0
   * NodeToken f0
   * NodeToken f1
  ...
  /**
   * Grammar production: f0 -> "[" f1 -> Identifier() f2 -> "+" f3 ->
   * IntegerLiteral()
   * f4 -> "]" f5 -> "=" f6 -> Identifier()
   * 
   * NodeToken f0
  ...
  /**
   * Grammar production: f0 -> Identifier() f1 -> "=" f2 -> "alloc" f3 -> "(" f4
   * -> Identifier() f5 -> ")"
   * 
   * Identifier f0
   * NodeToken f1
  ...
  public IRStruct visit(ErrorMessage n, functionStruct fStruct) {
    ...
    String errorObject = n.f2.f0.toString();/*
                                             ...
                                             * result.first.
                                             * add("mv a1, a0                                # Move msg address to a1");
                                             * result.first.
                                             * add("li a0, @print_string                     # Code for print_string ecall"
                                             * );
                                             * result.first.
                                             * add("ecall                                    # Print error message in a1"
                                             * );
                                             * result.first.
                                             * add("li a1, 10                                # Load newline character");
                                             * result.first.
                                             * add("li a0, @print_char                       # Code for print_char ecall"
                                             * );
                                             * result.first.
                                             * add("ecall                                    # Print newline");
                                             */
